...
int main() {
    ...
    DNASequence set_seq1("aaatctctg");
    std::cout << set_seq1.getSequenceStr() << std::endl;
    set_seq1.setNucleotide(0, 'g');
    set_seq1.setNucleotide(5, 'c');
    set_seq1.setNucleotide(8, 'c');
    set_seq1.setNucleotide(3, 'w');
    set_seq1.setNucleotide(30, 'w');
    std::cout << set_seq1.getSequenceStr() << std::endl;
